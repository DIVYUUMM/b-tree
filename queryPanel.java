...
//ye sb data memebers na private hai ,, 
// combobox is dropdown kindoff
...
public QueryPanel(JTabbedPane tabPane) { tabPane.addTab("Query", this);
initComponents();
}
...
lblselQuery.setFont(new Font("Monospaced", 0, 45)); lblselQuery.setForeground(new Color(255, 255, 255)); lblselQuery.setText("Select * from Table WHERE ");
String[] option = { "Name", "UserName", "Password" }; comboBoxQuery = new JComboBox<>(option); comboBoxQuery.setFont(new Font("Monospaced", 0, 20)); comboBoxQuery.setPreferredSize(new Dimension(150, 50));
##PR##");
##PWD##");
lbleql = new JLabel();
lbleql.setFont(new Font("Monospaced", 0, 45)); lbleql.setForeground(new Color(255, 255, 255)); lbleql.setText("=");
txtQuery = new JTextField(""); txtQuery.setColumns(10);
txtQuery.setFont(new Font("Monospaced", 0, 36));
btnSearch = new JButton();
btnSearch.setFont(new Font("Monospaced", 0, 50)); btnSearch.setText("Search"); btnSearch.addActionListener(this);
lblStats = new JLabel();
lblStats.setFont(new Font("Monospaced", 0, 25)); lblStats.setForeground(new Color(255, 255, 255));
...
GroupLayout.PREFERRED_SIZE).addPreferredGap(LayoutStyle.ComponentPlacement.RELATE D)
.addComponent(lbleql, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(txtQuery, GroupLayout.PREFERRED_SIZE,
...
layout.createParallelGroup(GroupLayout.Alignment.CENTER) .addComponent(lblselQuery,
GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE) .addComponent(comboBoxQuery,
GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE) .addComponent(lbleql,
GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE) .addComponent(txtQuery,
GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)) .addGap(50, 50, 50)
...
if(result.DataRow != null){ lblUser.setText
( ##UN##, Password: ##PWD##"
...
"Search Method: ##SM##, Time taken: ##TT##, Pages Read: .replace("##SM##", result.IndexesUsed? "Index Seek\n": "Table
